...
sl_config_timer_config_t ct_configuration = { .is_counter_mode_32bit_enabled =
		SL_CT_MODE_32BIT_ENABLE_MACRO, .is_counter0_soft_reset_enabled = false,
		...
		.is_counter0_buffer_enabled = false, .is_counter1_soft_reset_enabled =
				false, .is_counter1_periodic_enabled =
				SL_COUNTER1_PERIODIC_ENABLE_MACRO,
		.is_counter1_trigger_enabled = false,
		.is_counter1_sync_trigger_enabled =
				SL_COUNTER1_SYNC_TRIGGER_ENABLE_MACRO,
		.is_counter1_buffer_enabled = false, .counter0_direction =
				SL_COUNTER0_DIRECTION_MACRO, .counter1_direction =
				SL_COUNTER1_DIRECTION_MACRO, };
